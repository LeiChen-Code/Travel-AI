...
function ChatInner() {
  ...
  return (
    <div className={`w-full h-full flex flex-col items-center bg-[#FFFFFF]`}>
      ...
      {/* 消息展示区域 */}
      <div className="w-full h-full flex flex-col flex-1 justify-start overflow-y-auto bg-white pl-4 pt-4">
        <div
          ...
          {/* 加载中状态 */}
          {isLoading && (
            <div className="w-full flex justify-start px-2 py-4 text-gray-500">
